...
from ecotrace.modules.digital_product_passport.application.passport_service import (
    DocumentResponse,
    PassportCreate,
    PassportResponse,
    PassportUpdate,
...
@router.get(
    "/organizations/{organization_id}/digital-product-passports",
    response_model=Page[PassportResponse],
)
def list_passports(
    ...
    return passport_service.list_passports(
        db,
        user,
        organization_id,
        page=page,
...
def create_passport(
    ...
    return passport_service.create_passport(
        db,
        user,
        organization_id,
        payload,
...
@router.get(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}",
    response_model=PassportResponse,
)
def get_passport(
    organization_id: UUID, passport_id: UUID, db: DbSession, user: CurrentUser
) -> PassportResponse:
...
def update_passport(
    ...
    return passport_service.update_passport(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/submit-review",
    response_model=PassportResponse,
)
def submit_passport(
    organization_id: UUID,
    ...
    return passport_service.submit_passport(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/publish",
    response_model=PassportResponse,
)
def publish_passport(
    ...
    return passport_service.publish_passport(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/clone-version",
    response_model=PassportResponse,
)
def clone_passport(
    organization_id: UUID,
    ...
    return passport_service.clone_passport_version(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/revoke",
    response_model=PassportResponse,
)
def revoke_passport(
    organization_id: UUID,
    ...
    return passport_service.revoke_passport(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/archive",
    response_model=PassportResponse,
)
def archive_passport(
    ...
    return passport_service.archive_passport(
        db,
        user,
        organization_id,
        passport_id,
...
@router.post(
    "/organizations/{organization_id}/digital-product-passports/{passport_id}/documents",
...
async def upload_document(
    ...
    return passport_service.upload_document(
        db,
        user,
        organization_id,
        passport_id,
