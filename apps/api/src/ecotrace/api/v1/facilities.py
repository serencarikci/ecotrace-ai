...
@router.post(
    "/organizations/{organization_id}/facilities", response_model=FacilityResponse, status_code=201
)
def create_facility(
    organization_id: UUID,
...
@router.get(
    "/organizations/{organization_id}/facilities/{facility_id}", response_model=FacilityResponse
)
def get_facility(
    organization_id: UUID, facility_id: UUID, db: DbSession, user: CurrentUser
) -> FacilityResponse:
