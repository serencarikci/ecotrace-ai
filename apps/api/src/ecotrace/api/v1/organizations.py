...
@router.get(
    ...
    description="List organizations visible to the current user. System administrators see all; others see memberships only.",
)
...
def get_organization(
    organization_id: UUID, db: DbSession, user: CurrentUser
) -> OrganizationResponse:
...
@router.post(
    ...
    description="Create an organization. Restricted to system administrators.",
)
...
@router.patch(
    ...
    description="Update an organization. System admin or organization admin only.",
)
