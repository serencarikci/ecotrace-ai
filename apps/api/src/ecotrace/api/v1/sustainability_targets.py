...
from ecotrace.modules.sustainability_targets.application.target_service import (
    BaselineCreate,
    BaselineResponse,
    BaselineUpdate,
    InitiativeCreate,
...
intensity_router = APIRouter(
    prefix="/organizations/{organization_id}/intensity-metrics", tags=["Intensity Metrics"]
)
kpi_router = APIRouter(
    prefix="/organizations/{organization_id}/environmental-kpis", tags=["Environmental KPIs"]
)
baseline_router = APIRouter(
    prefix="/organizations/{organization_id}/sustainability-baselines",
    tags=["Sustainability Baselines"],
)
target_router = APIRouter(
    prefix="/organizations/{organization_id}/sustainability-targets",
    tags=["Sustainability Targets"],
)
initiative_router = APIRouter(
    prefix="/organizations/{organization_id}/reduction-initiatives", tags=["Reduction Initiatives"]
)
...
def list_intensity(
    ...
    return target_service.list_intensity_defs(
...
def create_intensity(
    ...
    return target_service.create_intensity_def(
        db,
        user,
        organization_id,
        payload,
...
def create_kpi(
    ...
    return target_service.create_kpi_def(
        db,
        user,
        organization_id,
        payload,
...
def list_baselines(
    ...
    return target_service.list_baselines(
...
def create_baseline(
    ...
    return target_service.create_baseline(
        db,
        user,
        organization_id,
        payload,
...
def get_baseline(
    organization_id: UUID, baseline_id: UUID, db: DbSession, user: CurrentUser
) -> BaselineResponse:
...
def approve_baseline(
    ...
    return target_service.approve_baseline(
        db,
        user,
        organization_id,
        baseline_id,
...
def archive_baseline(
    ...
    return target_service.archive_baseline(
        db,
        user,
        organization_id,
        baseline_id,
...
def create_target(
    ...
    return target_service.create_target(
        db,
        user,
        organization_id,
        payload,
...
def get_target(
    organization_id: UUID, target_id: UUID, db: DbSession, user: CurrentUser
) -> TargetResponse:
...
def approve_target(
    ...
    return target_service.approve_target(
        db,
        user,
        organization_id,
        target_id,
...
def get_target_progress(
    ...
    db: DbSession,
    user: CurrentUser,
    inventory_id: UUID | None = Query(None, alias="inventoryId"),
    allow_provisional: bool = Query(False, alias="allowProvisional"),
) -> dict[str, Any]:
    return target_service.target_progress(
        db,
        user,
        organization_id,
        target_id,
...
def list_initiatives(
    ...
    return target_service.list_initiatives(
        db, user, organization_id, page=page, page_size=page_size, status=status
    )
...
def create_initiative(
    ...
    return target_service.create_initiative(
        db,
        user,
        organization_id,
        payload,
...
def get_initiative(
    organization_id: UUID, initiative_id: UUID, db: DbSession, user: CurrentUser
) -> InitiativeResponse:
...
def transition_initiative(
    ...
    return target_service.transition_initiative(
        db,
        user,
        organization_id,
        initiative_id,
