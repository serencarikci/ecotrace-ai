...
from ecotrace.modules.reference_data.application.reference_service import (
    ActivityTypeCreate,
...
def list_units(
    ...
    return reference_service.list_units(
        db,
        user,
        page=page,
        page_size=page_size,
...
def create_unit(
    ...
    return reference_service.create_unit(
...
def update_unit(
    ...
    return reference_service.update_unit(
        db, user, unit_id, payload, request_id=request_id, ip_address=ip, user_agent=user_agent
    )
...
def list_activity_types(
    ...
    return reference_service.list_activity_types(
        db,
        user,
        page=page,
        page_size=page_size,
...
def create_activity_type(
    ...
    return reference_service.create_activity_type(
        db, user, payload, request_id=request_id, ip_address=ip, user_agent=user_agent
    )
...
def update_activity_type(
    ...
    return reference_service.update_activity_type(
        db,
        user,
        activity_type_id,
        payload,
