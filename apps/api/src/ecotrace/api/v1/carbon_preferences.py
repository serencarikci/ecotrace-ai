...
from ecotrace.modules.emission_factors.application.preference_service import (
    PreferenceCreate,
    PreferenceResponse,
    PreferenceUpdate,
)
...
def create_preference(
    ...
    return preference_service.create_preference(
        db,
        user,
        organization_id,
        payload,
...
def delete_preference(
    ...
    return preference_service.delete_preference(
        db,
        user,
        organization_id,
        preference_id,
...
def preview_match(
    organization_id: UUID, payload: MatchPreviewRequest, db: DbSession, user: CurrentUser
) -> dict[str, Any]:
