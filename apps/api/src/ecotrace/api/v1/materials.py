...
from ecotrace.modules.materials.application.material_service import (
    MaterialCreate,
    MaterialResponse,
    MaterialUpdate,
)
...
@router.post(
    "/organizations/{organization_id}/materials", response_model=MaterialResponse, status_code=201
)
def create_material(
    organization_id: UUID,
...
@router.get(
    "/organizations/{organization_id}/materials/{material_id}", response_model=MaterialResponse
)
def get_material(
    organization_id: UUID, material_id: UUID, db: DbSession, user: CurrentUser
) -> MaterialResponse:
...
@router.post(
    "/organizations/{organization_id}/materials/{material_id}/archive",
