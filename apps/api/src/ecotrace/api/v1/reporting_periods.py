...
@router.get(
    "/organizations/{organization_id}/reporting-periods", response_model=Page[PeriodResponse]
)
def list_periods(
...
@router.get(
    "/organizations/{organization_id}/reporting-periods/{period_id}", response_model=PeriodResponse
)
def get_period(
