...
@router.post(
    "/organizations/{organization_id}/equipment", response_model=EquipmentResponse, status_code=201
)
...
@router.get(
    "/organizations/{organization_id}/equipment/{equipment_id}", response_model=EquipmentResponse
)
def get_equipment(
    organization_id: UUID, equipment_id: UUID, db: DbSession, user: CurrentUser
) -> EquipmentResponse:
