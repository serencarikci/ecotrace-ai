...
from ecotrace.modules.scenarios.application.scenario_service import (
    AssumptionCreate,
    AssumptionResponse,
    ScenarioCreate,
    ScenarioResponse,
...
def get_scenario(
    organization_id: UUID, scenario_id: UUID, db: DbSession, user: CurrentUser
) -> ScenarioResponse:
...
def calculate_scenario(
    ...
    return scenario_service.calculate_scenario(
        db,
        user,
        organization_id,
        scenario_id,
...
def get_run(
    organization_id: UUID, scenario_id: UUID, run_id: UUID, db: DbSession, user: CurrentUser
) -> ScenarioRunResponse:
