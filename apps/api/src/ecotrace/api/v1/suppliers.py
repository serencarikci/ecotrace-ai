...
from ecotrace.modules.suppliers.application.supplier_service import (
    SupplierCreate,
    SupplierResponse,
    SupplierUpdate,
)
...
@router.post(
    "/organizations/{organization_id}/suppliers", response_model=SupplierResponse, status_code=201
)
def create_supplier(
    organization_id: UUID,
...
@router.get(
    "/organizations/{organization_id}/suppliers/{supplier_id}", response_model=SupplierResponse
)
def get_supplier(
...
@router.post(
    "/organizations/{organization_id}/suppliers/{supplier_id}/archive",
