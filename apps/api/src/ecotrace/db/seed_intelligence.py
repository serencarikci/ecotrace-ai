...
def _seed_regulatory(session: Session, org: Organization, actor: User) -> None:
    docs = [('EU', 'European Commission', 'DEMO-CSRD-2024', 'Demo CSRD overview (not legal guidance)', 'disclosure'), ('TR', 'Demo Authority', 'DEMO-TR-CLIMATE-1', 'Demo Turkey climate reporting note', 'climate')]
