...
class Material(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    __table_args__ = (
        ...
        Index("ix_materials_organization_id", "organization_id"),
        Index("ix_materials_material_category", "material_category"),
        Index("ix_materials_supplier_id", "supplier_id"),
    ...
    renewable_content_percentage: Mapped[Decimal | None] = mapped_column(
        Numeric(8, 4), nullable=True
    )
