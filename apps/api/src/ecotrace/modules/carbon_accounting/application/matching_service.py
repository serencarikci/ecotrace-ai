    ...
    *,
    ...
    for pref in prefs:
        ...
        pref_candidates.append(
            MatchCandidate(
                ...
                reason=f"Organization-approved factor preference (priority={pref.priority}"
    ...
    if len(top) > 1:
        ...
        result.errors.append(
            {
                "code": "ambiguous_factor",
                "message": f"Multiple factors share matching priority {best_priority}; user resolution required.",
            }
        )
