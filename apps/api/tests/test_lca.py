...
def test_product_crud_and_archive(client: TestClient) -> None:
    ...
    bad = client.post(
        ...
        json={
            ...
            "productType": "finished_good",
            "defaultUnitCode": "unit",
            "recyclabilityPercentage": "120",
        },
    )
    assert bad.status_code == 422
    archive = client.post(
        f"/api/v1/organizations/{org_id}/products/{product_id}/archive", headers=headers
    )
...
def test_supplier_material_bom_flow(client: TestClient) -> None:
    ...
    supplier = client.post(
        f"/api/v1/organizations/{org_id}/suppliers",
        headers=headers,
        json={
            "code": "SUP-T1",
            "name": "Test Supplier",
    ...
    material = client.post(
        f"/api/v1/organizations/{org_id}/materials",
        headers=headers,
        json={
            "code": "MAT-T1",
            "name": "Test Material",
    ...
    bom = client.post(
        f"/api/v1/organizations/{org_id}/products/{product_id}/boms",
        headers=headers,
        json={
            "name": "BOM draft",
            "items": [
    ...
    bom_id = bom.json()["id"]
    submit = client.post(
        f"/api/v1/organizations/{org_id}/boms/{bom_id}/submit-review", headers=headers
    )
    ...
    patch = client.patch(
        f"/api/v1/organizations/{org_id}/boms/{bom_id}", headers=headers, json={"name": "changed"}
    )
    assert patch.status_code in {400, 409, 422}
    cloned = client.post(
        f"/api/v1/organizations/{org_id}/boms/{bom_id}/clone-version", headers=headers
    )
...
def test_bom_cycle_detection(client: TestClient) -> None:
    ...
    a = client.post(
        f"/api/v1/organizations/{org_id}/products",
        headers=headers,
        json={"code": "CYC-A", "name": "A", "productType": "component", "defaultUnitCode": "unit"},
    ).json()["id"]
    b = client.post(
        f"/api/v1/organizations/{org_id}/products",
        headers=headers,
        json={"code": "CYC-B", "name": "B", "productType": "component", "defaultUnitCode": "unit"},
    ).json()["id"]
    bom_a = client.post(
        f"/api/v1/organizations/{org_id}/products/{a}/boms",
        headers=headers,
        json={
            "name": "A bom",
            "items": [{"componentProductId": b, "quantity": "1", "unitCode": "unit"}],
        },
    )
    assert bom_a.status_code == 201, bom_a.text
    bom_b = client.post(
        f"/api/v1/organizations/{org_id}/products/{b}/boms",
        headers=headers,
        json={
            "name": "B bom cycle",
            "items": [{"componentProductId": a, "quantity": "1", "unitCode": "unit"}],
        },
    )
...
def test_lca_calculate_and_public_passport(client: TestClient) -> None:
    ...
    headers = auth_headers(token)
    products = client.get(
        f"/api/v1/organizations/{org_id}/products", headers=headers, params={"search": "EcoBottle"}
    )
    ...
    studies = client.get(
        f"/api/v1/organizations/{org_id}/lca-studies", headers=headers, params={"search": "LCA-PCF"}
    )
    ...
    results = client.get(
        f"/api/v1/organizations/{org_id}/lca-studies/{study_id}/results", headers=headers
    )
    assert results.status_code == 200, results.text
    assert "disclaimer" in results.json()
    footprints = client.get(
        f"/api/v1/organizations/{org_id}/product-carbon-footprints",
        headers=headers,
...
def test_passport_publish_requires_admin_sections(client: TestClient) -> None:
    ...
    headers = auth_headers(token)
    products = client.get(
        f"/api/v1/organizations/{org_id}/products", headers=headers, params={"search": "BioPack"}
    ).json()["items"]
    product_id = products[0]["id"]
    create = client.post(
        f"/api/v1/organizations/{org_id}/digital-product-passports",
        headers=headers,
        json={
            "productId": product_id,
            "passportCode": "DPP-TEST-PUB",
            "title": "Test passport",
            "publicSlug": "test-passport-publish",
            "sections": [
                {
                    "sectionCode": "product_identity",
                    "title": "Identity",
                    "displayOrder": 1,
                    "isPublic": True,
                    "structuredDataJson": {"name": "x"},
                },
                {
    ...
    publish = client.post(
        f"/api/v1/organizations/{org_id}/digital-product-passports/{passport_id}/publish",
        headers=headers,
    )
    assert publish.status_code == 200, publish.text
    assert publish.json()["status"] == "published"
    revoke = client.post(
        f"/api/v1/organizations/{org_id}/digital-product-passports/{passport_id}/revoke",
        headers=headers,
    )
