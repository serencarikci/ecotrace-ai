...
def test_matching_precedence_country_over_global() -> None:
    country = _score_factor(
        _factor(geography_code="TR"),
        country_code="TR",
        region_code=None,
        technology_code=None,
        fuel_type=None,
    ...
    global_f = _score_factor(
        _factor(geography_code="GLOBAL"),
        country_code="TR",
        region_code=None,
        technology_code=None,
        fuel_type=None,
...
def test_matching_geo_tech_beats_country() -> None:
    scored = _score_factor(
        _factor(geography_code="TR", fuel_type="diesel"),
        country_code="TR",
        region_code=None,
        technology_code=None,
        fuel_type="diesel",
