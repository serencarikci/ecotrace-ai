# Life Cycle Assessment, Product Carbon Footprint, and Digital Product Passport
...
Import patterns for materials/suppliers/BOM/inventory reuse existing import conventions; row-level validation without silent invalid imports. Full CSV UI may be expanded later; API validation patterns are in place for product domain creates.
